        ...
        if(this.state.collab===true){
            return(
                <div className="projectCollabContainer">
                    <div className="projectCollabTitle projectInfoTitle">{projectProfileData[cookies.get("lang")]["infos"][0]}</div>
        ...
        return ( 
            <div className="projectInfosContainer">
                ...
                <div className="projectSoftwareContainer">
                    <div className="projectSoftwareTitle projectInfoTitle">{projectProfileData[cookies.get("lang")]["infos"][1]}</div>
